...
```yaml
  ...
  - body (optional)
  - bodyFile (optional)
  - multipart_form (optional): cannot be combined with body or bodyFile
...
`multipart_form` sends the request body as `multipart/form-data`. It cannot be combined with `body` or `bodyFile`.
